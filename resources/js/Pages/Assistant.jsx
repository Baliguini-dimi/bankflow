...
export default function Assistant() {
    const [messages, setMessages] = useState([
        {
            role: 'assistant',
            contenu: "Bonjour, je suis votre assistant IA de supervision bancaire. Je peux analyser vos transactions, résumer les anomalies détectées et répondre à vos questions sur les opérations du jour. Comment puis-je vous aider ?",
        },
    ]);
    ...
    const envoyer = async () => {
        ...
        try {
            ...
            setMessages(prev => [...prev, { role: 'assistant', contenu: 'Une erreur est survenue. Veuillez réessayer.' }]);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 h-[calc(100vh-160px)]">
                ...
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <div className="bg-white border border-zinc-200 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                            {[
                                { label: 'Modele', value: 'Grok-3-mini' },
                                { label: 'Fournisseur', value: 'xAI' },
